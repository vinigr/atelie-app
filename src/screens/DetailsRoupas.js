...
import { StyleSheet, Text, View, Button, TouchableOpacity, Image, FlatList, CheckBox } from 'react-native';
              ...
              return(
                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}> 
                  <CheckBox 
                    ...
                    // onChange={() => this.setState({ concluido: !item.concluido })}
                  />
                  <Text>{item.name}</Text> 
                </View>  
              )}}
